...
| Power Supply information for a rack mounted server might be displayed incorrectly
...
| Disk Space Utilization percentage is displayed incorrectly
...
| Thin provisioned status is displayed incorrectly

| https://mysupport.netapp.com/NOW/cgi-bin/bol?Type=Detail&Display=1211990[1211990^]
| Interfaces mapped to the VLAN in a Nexus switch might be mismatched with the actual device output
