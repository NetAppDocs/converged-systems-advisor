...
+
* Now you can see all of your systems in View All Systems at the top of the portal.
+
* Navigation to and from the Dashboard (home) view is available using a breadcrumb trail.
