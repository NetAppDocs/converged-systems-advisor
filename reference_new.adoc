...
=== Cluster interconnect switch
We added cluster interconnect switch (CIS) under Firmware Interoperability in the dashboard view. Now you can monitor the supportability of ONTAP cluster interconnect switches for the following models:
