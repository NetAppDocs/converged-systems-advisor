...
=== Upgrade Advisor
This new feature makes it possible for you to check compatibility for VMware.


=== Capacity card enhancements
In the Dashboard view, when you go to Capacity, you'll see two new links for Port Utilization and UCS Blade Server Utilization. You can use the links provided to see detailed information about your port and UCS Blade Server utilizations in the Storage tier.
