...
* <<Initial coverage of NVM3 designs>>
...
Initial configuration assurance checks have been added to monitor supportability of NVM3 ONTAP storage designs in FlexPod.
