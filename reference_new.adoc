...
All of these features and enhancements will be done automatically for you after you add your Flexpod into CSA. Follow the instructions for Getting Started to add your FlexPod into CSA.
