...
=== Cluster interconnect switch
We added cluster interconnect switch (CIS) in the dashboard view under Firmware Operability. Now you can monitor the supportability of your ONTAP cluster interconnect switches.
