...
Converged Systems Advisor can now automatically resolve issues that certain rules to fail.  This functionality is automatically enabled by restarting your agent.

=== Displaying suppressed rules

You can now display a list of suppressed rules within Converged Systems Advisor and elect to reenable alerts for rules that have been suppressed.
