...
If you are using a TACACS+ server and you need to grant CSA user privileges, click link:<<task_getting_started.adoc#granting-csa-user-privileges-using-a-tacacs-server, here>>
