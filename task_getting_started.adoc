...
//If you are using a TACACS+ server and you need to grant CSA user privileges, click link: <<task_getting_started.adoc#granting_csa_user_privileges_using_a_tacacs+_server, here>>
If you are using a TACACS+ server and you need to grant CSA user privileges, click link:<<task_getting_started.html#granting_csa_user_privileges_using_a_tacacs+_server, here>>
