...
If you are using a TACAS+ server and you need to grant CSA user privileges, click link: <<task_getting_started_customers.adoc#granting_csa_user_privileges_using_a_tacacs+_server, here>>
