...
+
The network configuration for the Debian virtual machine defaults to DHCP. NetworkManager is installed and provides a text user interface that you can start from the command https://manpages.debian.org/stretch/network-manager/nmtui.1.en.html[nmtui].
+
